...
//		User user = new User("manisha", "pass12","manisha@gmail.com");
...
//	}
	...
	public void resetPasswordFail() {
		User user = new User("manisha", "1234hj12","manisha@gmail.com");
		String newPass="pass12";
		boolean status = dao.resetPassword(user, newPass);
		assertFalse(status);
...
//		assertEquals("manisha@gmail.com", user.getEmail());
